...
class TwigExtensionTest extends \PHPUnit_Framework_TestCase {
    ...
    public function setUp()
    {
        ...
        $this->render
            ...
            ->willReturn(__DIR__ . "/../../../../Fixtures/templates/TwigExtension");
    }
    ...
    public function testRenderParentType(){
        ...
        $actual = $this->render->renderElementAs($form, $form->generateContext(), ["renderParentType", "renderParentType.parent"]);
